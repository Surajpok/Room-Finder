...
function getPro(){
	global $con;
	$get_room = "select * from rooms order by 1 DESC "; //LIMIT 0,9
					...
					<div class='listing'>
						<div class='listingImage'>
							<a href='./index.php?id=$id'>
								<img src='./images/room.jpg' class='listImg' alt='Rooms Near Me'>
							</a>
						</div>
...
function getMyPro(){
	global $con;
	$get_room = "select * from rooms where owner_id=5 order by 1 DESC";
	$result = mysqli_query($con,$get_room);
